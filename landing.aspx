<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="landing.aspx.cs" Inherits="Kitchen_project5.landing" %>
...
<body>
    <form id="form1" runat="server">
         <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <asp:Image ID="Image1" runat="server" ImageUrl="~\Images_testing\llllllllll-removebg-preview.png"  CssClass="imageLogo"/>
    ...
    text-align: center;
    font-style: italic;
    font-weight: bold;">Your Go-to Spot For The Best Kitchen Equipment </h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl" href="">Get Started!</a>
                    </div>
                </div>
            </div>
        </header>
